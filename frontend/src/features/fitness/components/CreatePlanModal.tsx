...
import { X, Loader2, Search, Check, Dumbbell } from "lucide-react";
...
export function CreatePlanModal({ isOpen, onClose }: CreatePlanModalProps) {
  ...
  // Carrega exercícios da biblioteca para seleção
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-950 border border-zinc-800 rounded-xl pl-9 pr-4 py-2 text-xs text-zinc-200 placeholder:text-zinc-600 outline-none focus:ring-1 focus:ring-purple-500"
                  />
                </div>
