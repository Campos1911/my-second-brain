      ...
      <div className="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:items-center lg:justify-between border-b border-border/40 pb-4 sm:pb-0 sm:border-0">
        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full lg:w-auto">
          ...
          <button
            ...
            className="bg-purple-600 hover:bg-purple-500 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl flex items-center justify-center gap-1.5 text-xs sm:text-sm font-medium transition-colors shadow-lg shadow-purple-500/10 active:scale-[0.98] h-[38px] sm:h-auto"
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <button
              ...
              className="p-1.5 hover:bg-muted text-muted-foreground hover:text-purple-400 rounded-lg transition-colors flex items-center gap-1 text-xs font-medium"
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center gap-1 bg-card/60 border border-border/60 p-1 rounded-xl w-full md:w-auto">
            <button
              ...
              className={`flex-1 md:flex-none flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-all ${
                !paymentMethodParam
