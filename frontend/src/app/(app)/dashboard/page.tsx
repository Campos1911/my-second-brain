...
export default function DashboardPage() {
  ...
  // 1. Ler as categorias vindas da URL (?categories=id1,id2)
  ...
  // 2. Atualiza a URL mantendo um histórico limpo
  ...
  // Sincroniza página atual caso venha da URL (opcional, mas recomendado)
  useEffect(() => {
  ...
  // 3. Hook consumindo os filtros dinâmicos e de categoria
  const { data, isLoading, isError } = useTransactions({
    page: currentPage,
    limit: LIMIT_PER_PAGE,
    month: currentMonth,
    year: currentYear,
    categoryIds: selectedCategoryIds, // Novo parâmetro enviado
  });
