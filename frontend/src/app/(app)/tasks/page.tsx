...
import { Plus, Search, Filter, Loader2, CheckSquare, X } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-500 text-white px-4 py-2.5 rounded-xl text-sm font-medium transition-colors shadow-lg shadow-primary-600/10"
        >
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 bg-zinc-900 border border-zinc-800/80 rounded-xl px-3 py-2.5">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 border border-dashed border-zinc-800 rounded-2xl text-center p-6">
          ...
          <h3 className="text-base font-semibold text-zinc-300">Nenhuma tarefa encontrada</h3>
